...
import { Plus, Search, Edit2, Trash2, Laptop, MoreVertical, Building2, User, Calendar, Eye, History, FileText, Shield, CheckCircle, XCircle, Clock, AlertTriangle, ExternalLink, MapPin, Package, X, QrCode, Download, ArrowRightLeft, Key, Globe, Wifi, Camera, Server, Lock, ChevronRight } from 'lucide-react';
